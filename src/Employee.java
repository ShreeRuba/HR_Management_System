public  class Employee implements User {
    ...
    public Employee(String startName, String endName, int enroll, int age, int workedDays, int vacationTaken, double amount,  int experience, String userName, String passWord ) {
        this.firstName = startName;
        this.lastName = endName;
        this.registration = enroll;
        this.age = age;
